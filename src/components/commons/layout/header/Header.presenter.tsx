...
import { ImageChange, Logoutsvg, PointPigsvg, ProfileArrow, Profilesvg } from '../../../../commons/styles/Iconsvg';
          ...
          {props.loggedIn?._id ? (
            <S.UserInfoBox>
              <S.FlexBox onClick={props.onClickModal}>
                {props.loggedIn?.picture === null ? <Profilesvg margin='0 28px 0 0' width='48' height='48' fill='#c4c4c4' /> : <S.Picture src={props.loggedIn?.picture} />}
              ...
              {props.isModal && (
                <>
                  <S.ModalabsoluteBox isModal={props.isModal}>
                    <ProfileArrow ratate='rotate(180deg)' width='16' height='12' fill='#fff' />
                  </S.ModalabsoluteBox>
                  ...
                  <S.ModalBox isModal={props.isModal}>
                    <S.UserInfo>
                      {props.loggedIn?.picture === null ? (
                        <div style={{ position: 'relative' }}>
                          ...
                          <S.SettingabsoluteBox onClick={props.onClickChangeImage}>
                            <ImageChange width='16' height='16' CilcleFill='#000' SettingFill='#fff' />
                      ...
                      <S.User>
                        ...
                        <S.UserPoint>{PointComma(props.loggedIn?.userPoint?.amount)} P</S.UserPoint>
                      </S.User>
                    </S.UserInfo>
                    <S.Hr Bg='#000' />
                    <S.MenuBox onClick={props.onClickCharge}>
                      <PointPigsvg margin='0 14px 0 0' width='20' height='19' fill='#bdbdbd' />
                      충전하기
                    </S.MenuBox>
                    ...
                    <S.MenuBox onClick={props.onClickLogout}>
                      <Logoutsvg margin='0 15px 0 0' width='18' height='18' fill='#bdbdbd' />
                      로그아웃
                    </S.MenuBox>
                  </S.ModalBox>
                </>
