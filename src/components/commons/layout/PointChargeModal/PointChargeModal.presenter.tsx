import { Closesvg, PointChargeIconsvg, SelectArrow } from '../../../../commons/styles/Iconsvg';
...
const PointChargeModalUI = (props: any) => {
  return (
    <S.ChargeModal>
      ...
      <S.IconBox>
        <PointChargeIconsvg width='80' height='54' pigfill='#ffd600' fill='#000' />
      </S.IconBox>

      <S.ModalText>충전하실 금액을 선택해주세요!</S.ModalText>

      <S.SelectedBox onClick={props.onClickOpen}>
        <S.Text>{props.chargePrice === 0 ? '포인트 선택' : <S.Bold>{props.chargePrice} 원</S.Bold>}</S.Text>
        {props.isOpen ? (
      ...
      {props.chargePrice === 0 ? (
        ...
        <S.ChargeBt onClick={props.onClickPoint} chargePrice={props.chargePrice}>
          충전하기
        </S.ChargeBt>
      )}
    </S.ChargeModal>
