  ...
  return (
    <S.Section>
      ...
      <S.FlexBox>
        ...
        <S.InputFlexBox>
          <S.Input type={props.showPresentPassword ? 'text' : 'password'} placeholder='현재 비밀번호를 입력해 주세요.' />
      ...
      <S.FlexBox>
        ...
        <S.InputFlexBox>
          <S.Input type={props.showNewPassword ? 'text' : 'password'} placeholder='새 비밀번호를 입력해주세요.' onChange={props.onChangePassword} />
      ...
      <S.FlexBox>
        ...
        <S.ColumnBox>
          <S.InputFlexBox>
            <S.Input type={props.showCheckPassword ? 'text' : 'password'} placeholder='새 비밀번호를 확인해주세요.' onChange={props.onChangePasswordCheck} />
          ...
          {props.password !== props.passwordCheck ? <S.Error color='red'>비밀번호가 일치하지 않습니다.</S.Error> : <S.Error color='#04fc46e2'>비밀번호가 일치합니다.</S.Error>}
        </S.ColumnBox>
      </S.FlexBox>
