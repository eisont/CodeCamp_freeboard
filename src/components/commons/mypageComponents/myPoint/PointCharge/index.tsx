...
const PointCharge = () => {
  ...
  const { data: LoadingData } = useQuery<Pick<IQuery, 'fetchPointTransactionsOfLoading'>, IQueryFetchPointTransactionsOfLoadingArgs>(FETCH_POINT_TRANSACTIONS_OF_LOADING);
