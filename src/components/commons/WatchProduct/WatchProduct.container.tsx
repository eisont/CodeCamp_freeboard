...
import * as S from './WatchProduct.styles';
    ...
    <S.Wrapper>
      ...
      {watchProduct?.map((el) => (
        <S.BestWrapper key={uuidv4()}>
          <S.PickCount>
            <Heartsvg margin='0 5.5px 0 0' width='15' height='13.76' fill='#ffd600' />
            <S.Num>{el?.pickedCount}</S.Num>
          </S.PickCount>
          <S.Image src={el?.images[0] ? `https://storage.googleapis.com/${el.images[0]}` : 'http://eumseongcci.korcham.net/images/no-image01.gif'} />
