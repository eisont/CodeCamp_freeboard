...
const MarketCommentWriteUI = (props: IMarketCommentWriteUIProps) => {
  return (
    <S.Wrapper>
      ...
      {!props.isEdit && (
        <S.Title>
          <CommentIconsvg margin='0 14px 0 0' width='20' height='20' fill='#ffd600' />
          문의하기
        </S.Title>
      )}
      <S.ContentsWrapper>
        ...
        <S.BottomWrapper>
          ...
          <S.Button onClick={props.isEdit ? props.onClickUpdate : props.onClickComment}>{props.isEdit ? '수정하기' : '문의하기'}</S.Button>
        </S.BottomWrapper>
      </S.ContentsWrapper>
    </S.Wrapper>
  );
