...
const MarketCommentAnswerWriteUI = (props: IMarketCommentWriteUIProps) => {
  return (
    <S.Wrapper>
      ...
      <S.ContentsWrapper>
        ...
        <S.BottomWrapper>
          ...
          <S.Button onClick={props.isEditSub ? props.onClickAnswer : props.onClickUpdate}>{props.isEditSub ? '대댓글 등록하기' : '대댓글 수정하기'}</S.Button>
        </S.BottomWrapper>
      </S.ContentsWrapper>
    </S.Wrapper>
  );
