...
import { Cartsvg, PointPigsvg, Profilesvg } from '../../../commons/styles/Iconsvg';
    ...
    <>
      ...
      <S.Wrapper>
        <S.UserInfo>
          ...
          <Uploads02 picture={pr.loggedInUser?.picture} myProfile={pr.myProfile} />

          <S.UserName>{pr.loggedInUser?.name}</S.UserName>
          <S.UserPoint>
            <PointPigsvg width='20' height='19' fill='#ffd600' margin='0 8px 0 0' />
            <div>{PointComma(pr.loggedInUser?.userPoint?.amount)}원</div>
          </S.UserPoint>

          {/* Section */}
          <S.MyMarketsItems myMarketsItems={pr.myMarketsItems} onClick={pr.onClickMyMarketItems}>
            <Cartsvg width='21' height='20' fill='#FFD600' margin='0 8px 0 0' />내 장터
          </S.MyMarketsItems>

          <S.MyPoint myPoint={pr.myPoint} onClick={pr.onClickMyPoint}>
            <PointPigsvg width='20' height='19' fill='#828282' margin='0 8px 0 0' />내 포인트
          </S.MyPoint>

          <S.MyProfile myProfile={pr.myProfile} onClick={pr.onClickMyProfile}>
            <Profilesvg width='20' height='20' fill='#828282' margin='0 8px 0 0' />내 프로필
          </S.MyProfile>
        </S.UserInfo>
