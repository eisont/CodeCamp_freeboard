...
export default function BoardWriteUI(props: IBoardWriteUIProps) {
  ...
  console.log("formState", props.formState?.errors);
  return (
    <S.Wrapper>
      <form onSubmit={props.handleSubmit(props.onClickSubmit)}>
        ...
        <S.WriterWrapper>
          ...
          <S.InputWrapper>
            ...
            {props.formState?.errors?.writer && (
              <S.Error>{props.formState?.errors?.writer}</S.Error>
            )}
          </S.InputWrapper>
          {/* 비밀번호 */}
          <S.InputWrapper>
            ...
            {props.formState?.errors?.password ? (
              <S.Error>{props.formState?.errors?.password}</S.Error>
            ) : (
              <></>
            )}
          </S.InputWrapper>
        ...
        <S.InputWrapper>
          ...
          {props.formState?.errors?.title ? (
            <S.Error>{props.formState?.errors?.title}</S.Error>
          ) : (
            <></>
          )}
        </S.InputWrapper>
        ...
        <S.InputWrapper>
          ...
          {props.formState?.errors?.contents ? (
            <S.Error>{props.formState?.errors?.contents}</S.Error>
          ) : (
            <></>
          )}
        </S.InputWrapper>
